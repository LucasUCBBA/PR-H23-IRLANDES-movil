  ...
  void showMessageDialog(BuildContext context, String iconSource, String title, String message) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            Image.asset(iconSource, width: 30,),
            const SizedBox(width: 10),
            Text(
              title,
              style: const TextStyle(color: Color(0xFF044086), fontWeight: FontWeight.bold, fontSize: 20,),
            ),
          ],
        ),
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              margin: EdgeInsets.only(top: 20, bottom: 10, left: leftPadding, right: rightPadding),
                              decoration: BoxDecoration(
                                color: Colors.white,
                                borderRadius: BorderRadius.circular(10),
                              ), 
                              child: Column(
                                children: [
                                  const Center(
                                    child : Image(image: AssetImage('assets/ui/logo.png'),width: 100),
                                  ),
                                  const Text('Detalles de la licencia', textAlign: TextAlign.center, style: TextStyle(color:Color(0xFF044086), fontWeight: FontWeight.bold, fontSize: 25)),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      const SizedBox(height: 5,),
                                      CustomRow('Fecha: ', formatDate(license.license_date)),
                                      const SizedBox(height: 5,),
                                      ...
                                      const Align(
                                        ...
                                        child: Text('Justificativo:', textAlign: TextAlign.center, style: TextStyle(color: Color(0xFF044086),  fontWeight: FontWeight.bold, fontSize: 16)),
                                      ),
                                      const SizedBox(height: 5,),
...
class CustomRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Text(label, style: const TextStyle(color: Color(0xFF044086),  fontWeight: FontWeight.bold, fontSize: 16)),
